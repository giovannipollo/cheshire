...
set_output_delay -min -clock $soc_clk [expr 0.05 * $SOC_TCK] [get_ports {sd_d_* sd_*_o}]
set_output_delay -max -clock $soc_clk [expr 0.05 * $SOC_TCK] [get_ports {sd_d_* sd_*_o}]
